class Board:
    ...
    def can_add_to(self, col):
        """ returns True if it is valid to place a checker in the 
            column col on the calling Board object, and False otherwise
        """
    ...
    def is_full(self):
        """ returns True if the called Board object is completely 
            full of checkers, False otherwise
        """
    ...
    def is_win_for(self, checker):
        """ accepts a parameter checker that is either 'X' or 'O', and 
            ...
            checker on the board, and False otherwise.
        """
        assert(checker == 'X' or checker == 'O')
